...
contextBridge.exposeInMainWorld("bc", {
  ...
  suspendHotkeys: () => ipcRenderer.invoke("preview:suspendHotkeys"),
  resumeHotkeys: () => ipcRenderer.invoke("preview:resumeHotkeys"),
  getRecording: () => ipcRenderer.invoke("preview:getRecording"),
  getSettings: () => ipcRenderer.invoke("preview:getSettings"),
  setSettings: (s: { maxItems?: number; retentionDays?: number }) => ipcRenderer.invoke("preview:setSettings", s),
  clearAll: () => ipcRenderer.invoke("preview:clearAll"),
